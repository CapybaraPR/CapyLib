...
/// Управляет всеми примитивами, источниками света и объектами, входящими в схематику.
/// </summary>
public sealed class SchematicObject
{
    ...
    /// <summary>
    /// Обновляет позиции всех примитивов и источников света относительно текущего центра схематики.
    /// </summary>
